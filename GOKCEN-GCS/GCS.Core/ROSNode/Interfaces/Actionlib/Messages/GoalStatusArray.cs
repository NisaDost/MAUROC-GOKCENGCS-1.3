...
namespace ROSNode.Actionlib
{
    ...
    internal unsafe partial class GoalStatusArray : global::Rosidl.Runtime.IMessage
    {
        ...
        public GoalStatusArray(
            ...
            global::ROSNode.Actionlib.GoalStatus[]? @statusList = null
        )
        {
            Header = @header ?? new global::ROSNode.Std.Header();
            StatusList = @statusList ?? global::System.Array.Empty<global::ROSNode.Actionlib.GoalStatus>();
        }
        ...
        public GoalStatusArray(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.StatusList = new global::ROSNode.Actionlib.GoalStatus[priv.StatusList.Size];
            var StatusList_span = priv.StatusList.AsSpan();
            for (int __i = 0; __i < this.StatusList.Length; __i++)
            {
                this.StatusList[__i] = new global::ROSNode.Actionlib.GoalStatus(in StatusList_span[__i], textEncoding);
            }
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::ROSNode.Actionlib.GoalStatus[] StatusList { get; set; }
        ...
        public void WriteTo(ref Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            priv.StatusList = new global::ROSNode.Actionlib.GoalStatus.PrivSequence(this.StatusList.Length);
            var StatusList_span = priv.StatusList.AsSpan();
            for (int __i = 0; __i < this.StatusList.Length; __i++)
            {
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[actionlib_msgs/msg/GoalStatus[] status_list]]></c>
            /// </summary>
            public global::ROSNode.Actionlib.GoalStatus.PrivSequence StatusList;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::ROSNode.Actionlib.GoalStatusArray.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::ROSNode.Actionlib.GoalStatusArray.PrivSequence.{caller}'.");
                }
            }
        }
    }
