...
namespace ROSNode.Rcl
{
    ...
    internal unsafe partial class ParameterEventDescriptors : global::Rosidl.Runtime.IMessage
    {
        ...
        public ParameterEventDescriptors(
            global::ROSNode.Rcl.ParameterDescriptor[]? @newParameters = null,
            global::ROSNode.Rcl.ParameterDescriptor[]? @changedParameters = null,
            global::ROSNode.Rcl.ParameterDescriptor[]? @deletedParameters = null
        )
        {
            NewParameters = @newParameters ?? global::System.Array.Empty<global::ROSNode.Rcl.ParameterDescriptor>();
            ChangedParameters = @changedParameters ?? global::System.Array.Empty<global::ROSNode.Rcl.ParameterDescriptor>();
            DeletedParameters = @deletedParameters ?? global::System.Array.Empty<global::ROSNode.Rcl.ParameterDescriptor>();
        }
        ...
        {
            this.NewParameters = new global::ROSNode.Rcl.ParameterDescriptor[priv.NewParameters.Size];
            var NewParameters_span = priv.NewParameters.AsSpan();
            for (int __i = 0; __i < this.NewParameters.Length; __i++)
            {
                this.NewParameters[__i] = new global::ROSNode.Rcl.ParameterDescriptor(in NewParameters_span[__i], textEncoding);
            }
        
            this.ChangedParameters = new global::ROSNode.Rcl.ParameterDescriptor[priv.ChangedParameters.Size];
            var ChangedParameters_span = priv.ChangedParameters.AsSpan();
            for (int __i = 0; __i < this.ChangedParameters.Length; __i++)
            {
                this.ChangedParameters[__i] = new global::ROSNode.Rcl.ParameterDescriptor(in ChangedParameters_span[__i], textEncoding);
            }
        
            this.DeletedParameters = new global::ROSNode.Rcl.ParameterDescriptor[priv.DeletedParameters.Size];
            var DeletedParameters_span = priv.DeletedParameters.AsSpan();
            for (int __i = 0; __i < this.DeletedParameters.Length; __i++)
            {
                this.DeletedParameters[__i] = new global::ROSNode.Rcl.ParameterDescriptor(in DeletedParameters_span[__i], textEncoding);
            }
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::ROSNode.Rcl.ParameterDescriptor[] NewParameters { get; set; }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::ROSNode.Rcl.ParameterDescriptor[] ChangedParameters { get; set; }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::ROSNode.Rcl.ParameterDescriptor[] DeletedParameters { get; set; }
        ...
        {
            priv.NewParameters = new global::ROSNode.Rcl.ParameterDescriptor.PrivSequence(this.NewParameters.Length);
            var NewParameters_span = priv.NewParameters.AsSpan();
            for (int __i = 0; __i < this.NewParameters.Length; __i++)
            {
            ...
            priv.ChangedParameters = new global::ROSNode.Rcl.ParameterDescriptor.PrivSequence(this.ChangedParameters.Length);
            var ChangedParameters_span = priv.ChangedParameters.AsSpan();
            for (int __i = 0; __i < this.ChangedParameters.Length; __i++)
            {
            ...
            priv.DeletedParameters = new global::ROSNode.Rcl.ParameterDescriptor.PrivSequence(this.DeletedParameters.Length);
            var DeletedParameters_span = priv.DeletedParameters.AsSpan();
            for (int __i = 0; __i < this.DeletedParameters.Length; __i++)
            {
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[rcl_interfaces/msg/ParameterDescriptor[] new_parameters]]></c>
            /// </summary>
            public global::ROSNode.Rcl.ParameterDescriptor.PrivSequence NewParameters;
            
            /// <summary>
            /// Originally defined as: <c><![CDATA[rcl_interfaces/msg/ParameterDescriptor[] changed_parameters]]></c>
            /// </summary>
            public global::ROSNode.Rcl.ParameterDescriptor.PrivSequence ChangedParameters;
            
            /// <summary>
            /// Originally defined as: <c><![CDATA[rcl_interfaces/msg/ParameterDescriptor[] deleted_parameters]]></c>
            /// </summary>
            public global::ROSNode.Rcl.ParameterDescriptor.PrivSequence DeletedParameters;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::ROSNode.Rcl.ParameterEventDescriptors.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::ROSNode.Rcl.ParameterEventDescriptors.PrivSequence.{caller}'.");
                }
            }
        }
    }
