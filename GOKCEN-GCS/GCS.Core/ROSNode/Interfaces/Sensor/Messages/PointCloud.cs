...
namespace ROSNode.Sensor
{
    ...
    internal unsafe partial class PointCloud : global::Rosidl.Runtime.IMessage
    {
        ...
        public PointCloud(
            ...
            global::ROSNode.Geometry.Point32[]? @points = null,
            global::ROSNode.Sensor.ChannelFloat32[]? @channels = null
        )
        {
            Header = @header ?? new global::ROSNode.Std.Header();
            Points = @points ?? global::System.Array.Empty<global::ROSNode.Geometry.Point32>();
            Channels = @channels ?? global::System.Array.Empty<global::ROSNode.Sensor.ChannelFloat32>();
        }
        ...
        public PointCloud(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.Points = new global::ROSNode.Geometry.Point32[priv.Points.Size];
            var Points_span = priv.Points.AsSpan();
            for (int __i = 0; __i < this.Points.Length; __i++)
            {
                this.Points[__i] = new global::ROSNode.Geometry.Point32(in Points_span[__i], textEncoding);
            }
        
            this.Channels = new global::ROSNode.Sensor.ChannelFloat32[priv.Channels.Size];
            var Channels_span = priv.Channels.AsSpan();
            for (int __i = 0; __i < this.Channels.Length; __i++)
            {
                this.Channels[__i] = new global::ROSNode.Sensor.ChannelFloat32(in Channels_span[__i], textEncoding);
            }
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::ROSNode.Geometry.Point32[] Points { get; set; }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::ROSNode.Sensor.ChannelFloat32[] Channels { get; set; }
        ...
        public void WriteTo(ref Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            priv.Points = new global::ROSNode.Geometry.Point32.PrivSequence(this.Points.Length);
            var Points_span = priv.Points.AsSpan();
            for (int __i = 0; __i < this.Points.Length; __i++)
            {
            ...
            priv.Channels = new global::ROSNode.Sensor.ChannelFloat32.PrivSequence(this.Channels.Length);
            var Channels_span = priv.Channels.AsSpan();
            for (int __i = 0; __i < this.Channels.Length; __i++)
            {
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[geometry_msgs/msg/Point32[] points]]></c>
            /// </remarks>
            public global::ROSNode.Geometry.Point32.PrivSequence Points;
            ...
            /// Originally defined as: <c><![CDATA[sensor_msgs/msg/ChannelFloat32[] channels]]></c>
            /// </remarks>
            public global::ROSNode.Sensor.ChannelFloat32.PrivSequence Channels;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::ROSNode.Sensor.PointCloud.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::ROSNode.Sensor.PointCloud.PrivSequence.{caller}'.");
                }
            }
        }
    }
