...
namespace ROSNode.Sensor
{
    ...
    internal unsafe partial class NavSatFix : global::Rosidl.Runtime.IMessage
    {
        ...
        public NavSatFix(
            ...
            global::ROSNode.Sensor.NavSatStatus? @status = null,
            double @latitude = 0d,
            double @longitude = 0d,
            double @altitude = 0d,
        ...
        )
        {
            ...
            Status = @status ?? new global::ROSNode.Sensor.NavSatStatus();
            Latitude = @latitude;
            Longitude = @longitude;
            Altitude = @altitude;
        ...
        public NavSatFix(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.Status = new global::ROSNode.Sensor.NavSatStatus(in priv.Status, textEncoding);
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::ROSNode.Sensor.NavSatStatus Status { get; set; }
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[sensor_msgs/msg/NavSatStatus status]]></c>
            /// </remarks>
            public global::ROSNode.Sensor.NavSatStatus.Priv Status;
            ...
            public global::System.Span<double> PositionCovariance
            {
                get
                {
                    fixed (global::ROSNode.Sensor.NavSatFix.Priv* __p = &this) return new (__p->__PositionCovariance, 9);
                }
            }
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::ROSNode.Sensor.NavSatFix.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::ROSNode.Sensor.NavSatFix.PrivSequence.{caller}'.");
                }
            }
        }
    }
