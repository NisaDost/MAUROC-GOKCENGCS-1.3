...
namespace ROSNode.Sensor
{
    ...
    internal unsafe partial class TimeReference : global::Rosidl.Runtime.IMessage
    {
        ...
        public TimeReference(
            ...
            global::ROSNode.Builtin.Time? @timeRef = null,
            string @source = ""
        )
        {
            Header = @header ?? new global::ROSNode.Std.Header();
            TimeRef = @timeRef ?? new global::ROSNode.Builtin.Time();
            Source = @source;
        }
        ...
        public TimeReference(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.TimeRef = new global::ROSNode.Builtin.Time(in priv.TimeRef, textEncoding);
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::ROSNode.Builtin.Time TimeRef { get; set; }
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[builtin_interfaces/msg/Time time_ref]]></c>
            /// </remarks>
            public global::ROSNode.Builtin.Time.Priv TimeRef;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::ROSNode.Sensor.TimeReference.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::ROSNode.Sensor.TimeReference.PrivSequence.{caller}'.");
                }
            }
        }
    }
