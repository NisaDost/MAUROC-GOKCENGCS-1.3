...
namespace ROSNode.Shape
{
    ...
    internal unsafe partial class Mesh : global::Rosidl.Runtime.IMessage
    {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public Mesh(
            global::ROSNode.Shape.MeshTriangle[]? @triangles = null,
            global::ROSNode.Geometry.Point[]? @vertices = null
        )
        {
            Triangles = @triangles ?? global::System.Array.Empty<global::ROSNode.Shape.MeshTriangle>();
            Vertices = @vertices ?? global::System.Array.Empty<global::ROSNode.Geometry.Point>();
        }
        ...
        {
            this.Triangles = new global::ROSNode.Shape.MeshTriangle[priv.Triangles.Size];
            var Triangles_span = priv.Triangles.AsSpan();
            for (int __i = 0; __i < this.Triangles.Length; __i++)
            {
                this.Triangles[__i] = new global::ROSNode.Shape.MeshTriangle(in Triangles_span[__i], textEncoding);
            }
        
            this.Vertices = new global::ROSNode.Geometry.Point[priv.Vertices.Size];
            var Vertices_span = priv.Vertices.AsSpan();
            for (int __i = 0; __i < this.Vertices.Length; __i++)
            {
                this.Vertices[__i] = new global::ROSNode.Geometry.Point(in Vertices_span[__i], textEncoding);
            }
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::ROSNode.Shape.MeshTriangle[] Triangles { get; set; }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::ROSNode.Geometry.Point[] Vertices { get; set; }
        ...
        {
            priv.Triangles = new global::ROSNode.Shape.MeshTriangle.PrivSequence(this.Triangles.Length);
            var Triangles_span = priv.Triangles.AsSpan();
            for (int __i = 0; __i < this.Triangles.Length; __i++)
            {
            ...
            priv.Vertices = new global::ROSNode.Geometry.Point.PrivSequence(this.Vertices.Length);
            var Vertices_span = priv.Vertices.AsSpan();
            for (int __i = 0; __i < this.Vertices.Length; __i++)
            {
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[shape_msgs/msg/MeshTriangle[] triangles]]></c>
            /// </remarks>
            public global::ROSNode.Shape.MeshTriangle.PrivSequence Triangles;
            ...
            /// Originally defined as: <c><![CDATA[geometry_msgs/msg/Point[] vertices]]></c>
            /// </remarks>
            public global::ROSNode.Geometry.Point.PrivSequence Vertices;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::ROSNode.Shape.Mesh.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::ROSNode.Shape.Mesh.PrivSequence.{caller}'.");
                }
            }
        }
    }
