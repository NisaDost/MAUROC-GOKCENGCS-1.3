...
namespace ROSNode.Geometry
{
    ...
    internal unsafe partial class TwistStamped : global::Rosidl.Runtime.IMessage
    {
        ...
        )
        {
            ...
            Twist = @twist ?? new global::ROSNode.Geometry.Twist();
        }
        ...
        public TwistStamped(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.Twist = new global::ROSNode.Geometry.Twist(in priv.Twist, textEncoding);
        }
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[geometry_msgs/msg/Twist twist]]></c>
            /// </summary>
            public global::ROSNode.Geometry.Twist.Priv Twist;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::ROSNode.Geometry.TwistStamped.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::ROSNode.Geometry.TwistStamped.PrivSequence.{caller}'.");
                }
            }
        }
    }
