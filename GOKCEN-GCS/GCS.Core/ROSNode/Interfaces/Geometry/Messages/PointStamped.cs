...
namespace ROSNode.Geometry
{
    ...
    internal unsafe partial class PointStamped : global::Rosidl.Runtime.IMessage
    {
        ...
        public PointStamped(
            ...
            global::ROSNode.Geometry.Point? @point = null
        )
        {
            Header = @header ?? new global::ROSNode.Std.Header();
            Point = @point ?? new global::ROSNode.Geometry.Point();
        }
        ...
        public PointStamped(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.Point = new global::ROSNode.Geometry.Point(in priv.Point, textEncoding);
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::ROSNode.Geometry.Point Point { get; set; }
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[geometry_msgs/msg/Point point]]></c>
            /// </summary>
            public global::ROSNode.Geometry.Point.Priv Point;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::ROSNode.Geometry.PointStamped.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::ROSNode.Geometry.PointStamped.PrivSequence.{caller}'.");
                }
            }
        }
    }
