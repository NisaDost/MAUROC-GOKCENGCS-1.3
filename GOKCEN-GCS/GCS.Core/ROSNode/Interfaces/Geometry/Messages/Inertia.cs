...
namespace ROSNode.Geometry
{
    ...
    internal unsafe partial class Inertia : global::Rosidl.Runtime.IMessage
    {
        ...
        public Inertia(
            double @m = 0d,
            global::ROSNode.Geometry.Vector3? @com = null,
            double @ixx = 0d,
            double @ixy = 0d,
            double @ixz = 0d,
            double @iyy = 0d,
        ...
        {
            M = @m;
            Com = @com ?? new global::ROSNode.Geometry.Vector3();
            İxx = @ixx;
            İxy = @ixy;
            İxz = @ixz;
            İyy = @iyy;
        ...
        {
            this.M = priv.M;
            this.Com = new global::ROSNode.Geometry.Vector3(in priv.Com, textEncoding);
            this.İxx = priv.İxx;
            this.İxy = priv.İxy;
            this.İxz = priv.İxz;
            this.İyy = priv.İyy;
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::ROSNode.Geometry.Vector3 Com { get; set; }
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[geometry_msgs/msg/Vector3 com]]></c>
            /// </remarks>
            public global::ROSNode.Geometry.Vector3.Priv Com;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::ROSNode.Geometry.Inertia.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::ROSNode.Geometry.Inertia.PrivSequence.{caller}'.");
                }
            }
        }
    }
