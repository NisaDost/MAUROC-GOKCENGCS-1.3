...
namespace ROSNode.Geometry
{
    ...
    internal unsafe partial class PolygonStamped : global::Rosidl.Runtime.IMessage
    {
        ...
        public PolygonStamped(
            ...
            global::ROSNode.Geometry.Polygon? @polygon = null
        )
        {
            Header = @header ?? new global::ROSNode.Std.Header();
            Polygon = @polygon ?? new global::ROSNode.Geometry.Polygon();
        }
        ...
        public PolygonStamped(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.Polygon = new global::ROSNode.Geometry.Polygon(in priv.Polygon, textEncoding);
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::ROSNode.Geometry.Polygon Polygon { get; set; }
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[geometry_msgs/msg/Polygon polygon]]></c>
            /// </summary>
            public global::ROSNode.Geometry.Polygon.Priv Polygon;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::ROSNode.Geometry.PolygonStamped.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::ROSNode.Geometry.PolygonStamped.PrivSequence.{caller}'.");
                }
            }
        }
    }
