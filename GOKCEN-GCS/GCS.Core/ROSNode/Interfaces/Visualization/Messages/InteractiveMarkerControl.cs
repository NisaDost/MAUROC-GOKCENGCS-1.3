...
namespace ROSNode.Visualization
{
    ...
    internal unsafe partial class InteractiveMarkerControl : global::Rosidl.Runtime.IMessage
    {
        ...
        public InteractiveMarkerControl(
            ...
            global::ROSNode.Visualization.Marker[]? @markers = null,
        ...
        )
        {
            ...
            Markers = @markers ?? global::System.Array.Empty<global::ROSNode.Visualization.Marker>();
        ...
        public InteractiveMarkerControl(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.Markers = new global::ROSNode.Visualization.Marker[priv.Markers.Size];
            var Markers_span = priv.Markers.AsSpan();
            for (int __i = 0; __i < this.Markers.Length; __i++)
            {
                this.Markers[__i] = new global::ROSNode.Visualization.Marker(in Markers_span[__i], textEncoding);
            }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::ROSNode.Visualization.Marker[] Markers { get; set; }
        ...
        public void WriteTo(ref Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            priv.Markers = new global::ROSNode.Visualization.Marker.PrivSequence(this.Markers.Length);
            var Markers_span = priv.Markers.AsSpan();
            for (int __i = 0; __i < this.Markers.Length; __i++)
            {
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[visualization_msgs/msg/Marker[] markers]]></c>
            /// </remarks>
            public global::ROSNode.Visualization.Marker.PrivSequence Markers;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::ROSNode.Visualization.InteractiveMarkerControl.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::ROSNode.Visualization.InteractiveMarkerControl.PrivSequence.{caller}'.");
                }
            }
        }
    }
