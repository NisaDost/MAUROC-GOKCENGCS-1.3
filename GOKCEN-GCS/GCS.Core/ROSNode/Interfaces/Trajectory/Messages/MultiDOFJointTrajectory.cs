...
namespace ROSNode.Trajectory
{
    ...
    internal unsafe partial class MultiDOFJointTrajectory : global::Rosidl.Runtime.IMessage
    {
        ...
        public MultiDOFJointTrajectory(
            ...
            global::ROSNode.Trajectory.MultiDOFJointTrajectoryPoint[]? @points = null
        )
        {
            Header = @header ?? new global::ROSNode.Std.Header();
            JointNames = @jointNames ?? global::System.Array.Empty<string>();
            Points = @points ?? global::System.Array.Empty<global::ROSNode.Trajectory.MultiDOFJointTrajectoryPoint>();
        }
        ...
        public MultiDOFJointTrajectory(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.Points = new global::ROSNode.Trajectory.MultiDOFJointTrajectoryPoint[priv.Points.Size];
            var Points_span = priv.Points.AsSpan();
            for (int __i = 0; __i < this.Points.Length; __i++)
            {
                this.Points[__i] = new global::ROSNode.Trajectory.MultiDOFJointTrajectoryPoint(in Points_span[__i], textEncoding);
            }
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::ROSNode.Trajectory.MultiDOFJointTrajectoryPoint[] Points { get; set; }
        ...
        public void WriteTo(ref Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            priv.Points = new global::ROSNode.Trajectory.MultiDOFJointTrajectoryPoint.PrivSequence(this.Points.Length);
            var Points_span = priv.Points.AsSpan();
            for (int __i = 0; __i < this.Points.Length; __i++)
            {
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[trajectory_msgs/msg/MultiDOFJointTrajectoryPoint[] points]]></c>
            /// </summary>
            public global::ROSNode.Trajectory.MultiDOFJointTrajectoryPoint.PrivSequence Points;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::ROSNode.Trajectory.MultiDOFJointTrajectory.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::ROSNode.Trajectory.MultiDOFJointTrajectory.PrivSequence.{caller}'.");
                }
            }
        }
    }
