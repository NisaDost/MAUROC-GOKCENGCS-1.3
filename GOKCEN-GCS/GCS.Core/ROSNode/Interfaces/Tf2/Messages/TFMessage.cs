...
namespace ROSNode.Tf2
{
    ...
    internal unsafe partial class TFMessage : global::Rosidl.Runtime.IMessage
    {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public TFMessage(
            global::ROSNode.Geometry.TransformStamped[]? @transforms = null
        )
        {
            Transforms = @transforms ?? global::System.Array.Empty<global::ROSNode.Geometry.TransformStamped>();
        }
        ...
        {
            this.Transforms = new global::ROSNode.Geometry.TransformStamped[priv.Transforms.Size];
            var Transforms_span = priv.Transforms.AsSpan();
            for (int __i = 0; __i < this.Transforms.Length; __i++)
            {
                this.Transforms[__i] = new global::ROSNode.Geometry.TransformStamped(in Transforms_span[__i], textEncoding);
            }
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::ROSNode.Geometry.TransformStamped[] Transforms { get; set; }
        ...
        {
            priv.Transforms = new global::ROSNode.Geometry.TransformStamped.PrivSequence(this.Transforms.Length);
            var Transforms_span = priv.Transforms.AsSpan();
            for (int __i = 0; __i < this.Transforms.Length; __i++)
            {
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[geometry_msgs/msg/TransformStamped[] transforms]]></c>
            /// </summary>
            public global::ROSNode.Geometry.TransformStamped.PrivSequence Transforms;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::ROSNode.Tf2.TFMessage.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::ROSNode.Tf2.TFMessage.PrivSequence.{caller}'.");
                }
            }
        }
    }
